...
module.exports = {
  ...
  DRUGS: {
    cocaina: { name: 'Cocaína',  emoji: '🤍', civil: 1485, contratado: 1580, venda: 1940 },
    erva:    { name: 'Erva',     emoji: '🌿', civil:  860, contratado:  880, venda: 1070 },
    meta:    { name: 'Meta',     emoji: '🔵', civil: 1730, contratado: 1800, venda: 2210 },
    petro:   { name: 'Petro',    emoji: '🛢️', civil: 8250, contratado: 8125, venda: 10730 },
    opio:    { name: 'Ópio',     emoji: '🌸', civil: 1405, contratado: 1500, venda: 1830 },
  },
